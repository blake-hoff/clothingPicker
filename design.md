...
This is intended to be used for data collection for a later application which will require a large amount of data, to be used to predict what the user wants to wear next.
...
- Step 2: User clicks on the plus button in the clothing list.
- Step 3: User writes their clothing here. (later) User chooses to add the shirt they wear. Then they choose the pants they wear in this category.
- Step 4: User does not want to add any other categories (socks, underwear, shoes, hat, jacket, etc)
- Step 5: The user now has todays clothing in their list.
